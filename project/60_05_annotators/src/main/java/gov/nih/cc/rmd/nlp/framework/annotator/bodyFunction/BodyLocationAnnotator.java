...
// =================================================
/**
 * BodyLocationAnnotator creates BodyLocation in text
 * 
 *  This takes advantage of the term lookup, and adds
 *  concepts based on terms that could have a BodyLocation
...
public class BodyLocationAnnotator extends JCasAnnotator_ImplBase {
  ...
  public void process(JCas pJCas) throws AnalysisEngineProcessException {
    ...
    if ( terms != null && !terms.isEmpty())
      for ( Annotation term: terms ) {
        ...
        if ( categories != null && ( categories.contains("BodyLocation") || categories.contains("BodyLaterality") ) )
...
// =================================================
  ...
  */
  // =================================================
  private final BodyLocation createBodyLocation(JCas pJCas, Annotation pTerm) {
   
    
    BodyLocation statement = new BodyLocation( pJCas);
...
public void destroy() {
  ...
  public void initialize(String[] pArgs) throws ResourceInitializationException {
    ...
    this.BodyLocationAnnotationParameter = U.getOption(pArgs,  "--BodyLocationParam=", "aDefaultValue"); 
  ...
  private String BodyLocationAnnotationParameter;
