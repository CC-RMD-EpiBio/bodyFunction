// =================================================
/**
 * BodyLateralityAnnotator creates BodyLaterality in text
 * 
 *  This takes advantage of the term lookup, and adds
 *  concepts based on terms that could have a BodyLaterality
...
import gov.nih.cc.rmd.framework.BodyLaterality;
...
public class BodyLateralityAnnotator extends JCasAnnotator_ImplBase {
  ...
  public void process(JCas pJCas) throws AnalysisEngineProcessException {
    ...
    if ( terms != null && !terms.isEmpty())
      for ( Annotation term: terms ) {
        ...
        if ( categories != null && categories.contains("BodyLaterality"))
          if ( //  !((LexicalElement) term ).getConditional() && 
            ...
            createBodyLaterality(pJCas, term );
      }
...
// =================================================
  /**
   * createBodyLaterality 
   * 
   * @param pJCas
   * @param pTerm
   * @return BodyLaterality
  */
  // =================================================
  private final BodyLaterality createBodyLaterality(JCas pJCas, Annotation pTerm) {
   
    
    BodyLaterality statement = new BodyLaterality( pJCas);
  ...
  } // end Method createBodyLaterality() ----------
