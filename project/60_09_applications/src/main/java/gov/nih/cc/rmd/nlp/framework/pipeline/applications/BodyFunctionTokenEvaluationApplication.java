...
import gov.nih.cc.rmd.nlp.framework.pipeline.BodyFunctionTokenEvaluationPipeline;
...
public class BodyFunctionTokenEvaluationApplication {
  ...
  public static void main(String[] pArgs) {
    ...
    try {
      ...
      // -------------------
      BodyFunctionPipeline   pipeline = new BodyFunctionTokenEvaluationPipeline( args );
  ...
  public static String[] setArgs(String pArgs[]) {
    ...
    // ------------------------------------
    String  focusLabel = U.getOption(pArgs, "--focusLabel=", "FalsePositive");
