// ------------------------------------------------------------
/**
 * BodyFunctionHumanAnnotationStatsApplication will print out the summary of annotation
 * types per document
 * 
 * @author  G.o.d.
 * @created 2020.08.01
...
import gov.nih.cc.rmd.nlp.framework.pipeline.BodyFunctionHumanAnnotationStatsPipeline;
...
public class BodyFunctionHumanAnnotationStatsApplication {
  ...
  public static void main(String[] pArgs) {
    ...
    try {
      ...
      // -------------------
      BodyFunctionHumanAnnotationStatsPipeline   pipeline = new BodyFunctionHumanAnnotationStatsPipeline( args );
  ...
  public static String[] setArgs(String pArgs[]) {
    ...
    String    outputDir = U.getOption(pArgs, "--outputDir=", inputDir + "_BodyFunction_Stats_" + dateStamp);
 ...
 //   String  outputTypes = U.getOption(pArgs, "--outputTypes=" ,"BodyLocation:BodyFunction:Strength:RangeOfMotion:Quantifier:LexicalElement:Gold:Copper:TruePositive:FalsePositive:FalseNegative:FalsePostitive:TP:TN:FP:FN" );
    ...
    if ( Use.version(pArgs, args ) ||
        Use.usageAndExitIfHelp( "BodyFunctionHumanAnnotationStatsApplication", pArgs, args ) )
